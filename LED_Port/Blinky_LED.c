...
void initLED(void)
{
 ...
 //   IfxPort_setPinModeOutput(LED2, IfxPort_OutputMode_pushPull, IfxPort_OutputIdx_general);
    ...
    IfxPort_setGroupModeOutput(LED1, 0xff, IfxPort_OutputMode_pushPull, IfxPort_OutputIdx_general);
